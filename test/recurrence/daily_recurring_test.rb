...
class DailyRecurringTest < Minitest::Test
  ...
  test "starts at 2008-03-19 and repeat until 2008-04-24" do
    r = recurrence(:every => :day, :starts => "2008-03-19", :until => "2008-04-24")
  ...
  test "starts at 2008-03-19 and repeat through 2008-04-24" do
    r = recurrence(:every => :day, :starts => "2008-03-19", :through => "2008-04-24")
    assert_equal "2008-03-19", r.events[0].to_s
    assert_equal "2008-03-20", r.events[1].to_s
    assert_equal "2008-04-24", r.events[-1].to_s
  end
  ...
  test "doesn't have a lacking day if the interval does not match the last day" do
    r = recurrence(
      :every    => :day,
      :starts   => "2008-03-19",
      :through  => "2008-04-25",
  ...
  test "uses except" do
    ...
    refute r.events.include?(Date.tomorrow)
    assert r.events.include?(Date.tomorrow+1.day)
  end
end
